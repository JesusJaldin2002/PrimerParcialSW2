            ...
            <div class="col-md-12">
                <div class="card shadow-sm">
                    <div class="card-header d-flex justify-content-between align-items-center">
                        <h4 class="mb-0"><b>Crear Product Backlog Inicial</b></h4>
                    </div>
                    ...
                    <div class="card-body py-4">
                        ...
                        @endif
                        <form id="backlogForm" action="{{ route('backlogs.store', request()->route('id')) }}"
                            method="POST">
                            @csrf
                                ...
                                <table class="table table-bordered table-striped" id="backlogTable">
                                    ...
                                    <tbody id="backlogBody">
                                        <tr>
                                            ...
                                            <td><input type="number" name="sprints[]" class="form-control" min="1"
                                                    value="1"></td>
                                            <td>
